"""python-can Bus lifecycle for the VKGS USB backend."""
...
class UsbCanBus(can.BusABC):
    ...
    def identify(self, enabled: bool = True) -> None:
        ...
        with self._io_lock:
            self._protocol_device.identify(enabled)
...
class vkgs_usb_bus(UsbCanBus):
    """python-can backend for the VKGS USB protocol."""

    DEVICE_MODULE = protocol
    INTERFACE_NAME = "vkgs_usb"
